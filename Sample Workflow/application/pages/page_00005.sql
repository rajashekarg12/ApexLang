...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(22045180082184374)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(22068335959671113)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(22069476557671130)
,p_plug_name=>'Initiated by Me - Smart Filters'
,p_static_id=>'initiated-by-me-smart-filters'
,p_parent_plug_id=>wwv_flow_imp.id(22068335959671113)
...
,p_filtered_region_id=>wwv_flow_imp.id(22069584806671130)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22072783043671152)
,p_name=>'P5_APPLICATION'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(22069476557671130)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22071214634671136)
,p_name=>'P5_CATEGORY'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(22069476557671130)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22070365538671134)
,p_name=>'P5_DUE'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22073438600671154)
,p_name=>'P5_INITIATED'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(22069476557671130)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22073033683671154)
,p_name=>'P5_INITIATOR'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(22069476557671130)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22072422084671151)
,p_name=>'P5_OUTCOME'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(22069476557671130)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22073877898671155)
,p_name=>'P5_OWNER'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(22069476557671130)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22071565017671137)
,p_name=>'P5_PRIORITY'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(22069476557671130)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22069927520671133)
,p_name=>'P5_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(22069476557671130)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22071965791671139)
,p_name=>'P5_STATE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(22069476557671130)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22070803160671135)
,p_name=>'P5_TYPE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(22069476557671130)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(22069584806671130)
...
,p_query_order_by=>'{"itemName":"P5_SORT_BY","orderBys":[{"key":"CREATED_ON","expr":"created_on desc"},{"key":"DUE_ON","expr":"priority asc, due_on asc nulls last"}]}'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22078110448671169)
,p_name=>'ACTUAL_OWNER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22085047733671173)
,p_name=>'BADGE_STATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22084579727671173)
,p_name=>'BADGE_TEXT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22083123030671172)
,p_name=>'CREATED_AGO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22083545919671172)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22082571513671172)
,p_name=>'CREATED_ON'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22076099217671168)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22076616551671168)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22080549067671171)
,p_name=>'DUE_CODE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22079609284671170)
,p_name=>'DUE_IN'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22080032934671171)
,p_name=>'DUE_IN_HOURS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22079095007671170)
,p_name=>'DUE_ON'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22077542244671169)
,p_name=>'INITIATOR'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22081571924671171)
,p_name=>'IS_COMPLETED'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22084098806671172)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22082055690671172)
,p_name=>'OUTCOME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22078611881671169)
,p_name=>'PRIORITY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22081057197671171)
,p_name=>'STATE_CODE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22077124946671169)
,p_name=>'SUBJECT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22075595038671168)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22074564461671164)
,p_name=>'TASK_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(22075034769671167)
,p_name=>'TASK_TYPE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_component_action(
 p_id=>wwv_flow_imp.id(22085588776671173)
,p_region_id=>wwv_flow_imp.id(22069584806671130)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22086496262671179)
,p_name=>'P5_SHOW_EXPIRED'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(22069584806671130)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22086114743671176)
,p_name=>'P5_SORT_BY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(22069584806671130)
,p_item_display_point=>'ORDER_BY_ITEM'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22069090950671126)
,p_name=>'P5_TASK_ID'
,p_item_sequence=>10
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(22086872025671181)
,p_name=>'Refresh - Initiated by Me - Report'
,p_static_id=>'refresh-initiated-by-me-report'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(22069584806671130)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosecanceldialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(22087233726671182)
,p_event_id=>wwv_flow_imp.id(22086872025671181)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(22069584806671130)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'maintain_pagination', 'N')).to_clob
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(22087735556671184)
,p_event_id=>wwv_flow_imp.id(22086872025671181)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(22069476557671130)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'maintain_pagination', 'N')).to_clob
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(22088307298671184)
,p_name=>'Refresh - Initiated by Me - Report'
,p_static_id=>'refresh-initiated-by-me-report-2'
,p_event_sequence=>30
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(22088702013671184)
,p_event_id=>wwv_flow_imp.id(22088307298671184)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-refresh'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(22089184916671184)
,p_event_id=>wwv_flow_imp.id(22088307298671184)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
