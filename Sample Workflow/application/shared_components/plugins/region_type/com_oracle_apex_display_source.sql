...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(962382874928951338)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(962383038310951341)
,p_plugin_id=>wwv_flow_imp.id(962382874928951338)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(962383430550951348)
,p_plugin_id=>wwv_flow_imp.id(962382874928951338)
,p_attribute_scope=>'COMPONENT'
